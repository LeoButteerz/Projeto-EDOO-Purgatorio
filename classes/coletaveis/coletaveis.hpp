...
{
protected:
    //ver sobre float pra eles
    float lifetime; //tempo de vida de duração no mapa do coletavel
    float timer; //temporizador interno da classe
    bool ativo; //para saber se o coletavel esta presente no mapa ainda
    player* ponteiro;
public:
    coletaveis(player* ponteiro_interno, float self_lifetime);//construtor
...
class vida : public coletaveis{//em relação ao coletavel de vida
    ...
    vida(player* ponteiro_interno, float self_lifetime);//construtor da mesma
...
class tempo : public coletaveis{//relacionado ao coletavel que da mais tempo
    ...
    tempo(player* ponteiro_interno, float self_lifetime);//construtor da mesma
...
class flag : public coletaveis{//coletavel flag
    ...
    flag(player* ponteiro_interno, float self_lifetime);//construtor da mesma
